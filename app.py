...
translations = {
    ...
    "አማርኛ": {
        ...
        "rec_text": "የሳተላይት መረጃ ትንተና፡ ፍጹም ደረቅ ወቅት ከጥቅምት እስከ የካቲት (October to February) እንዲሁም በሰኔ ወር ላይ ከፍተኛ ድርቅ ይከሰታል። ምርጥ መከር የሚገኘው በሀምሌ እና መስከረም የክረምት ዝናብ ወቅት ብቻ ነው። ምክረ ሀሳብ፡ የዛሬው የትነት መጠን 7.1mm በመሆኑ የውሃ ማስተላለፊያ መስመሮችን ጠዋት ከ11፡00 እስከ 1፡30 ሰዓት ድረስ ለ65 ደቂቃ ይክፈቱ።"
    },
    "Oromoo": {
